"""
Response builder for generating natural language answers.
"""
...
def build_answer(stats: dict[str, Any], submission: list[dict[str, Any]]) -> str:
    """
    Build a natural, informative chat response from matcher stats and submission.
    ...
    if unmatched_entries:
        ...
        lines.append("")
        lines.append(f"No competitor found for: {', '.join(names)}.")
